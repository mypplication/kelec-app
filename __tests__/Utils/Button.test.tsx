...
describe('Button - Light theme', () => {
    ...
    test('renders with the default button style of the light theme', () => {
    ...
    test('applies the neutral button style, including its border, when provided', () => {
        const { getByTestId } = render(
            <Button
                testID="buttonTestId"
                text="title"
    ...
    test('applies the delete button style', () => {
        const { getByTestId } = render(
            <Button
                testID="buttonTestId"
                text="Delete"
    ...
    test('uses disabled colors when the disabled prop is set', () => {
        const { getByTestId } = render(
        ...
        expect(bgStyle).toMatchObject({
            backgroundColor: expected.colors.backgroundDisabled,
        });
        expect(textStyle).toMatchObject({
            color: expected.colors.textDisabled,
        });
    });
});
...
describe('Button - Dark theme', () => {
    ...
    test('renders with the default button style of the dark theme', () => {
        const { getByTestId } = render(
            <Button testID="buttonTestId" text="title" icon="person" onPress={() => {
            }} />,
        );
    ...
    test('applies the neutral button style without a border', () => {
        const { getByTestId } = render(
            <Button
                testID="buttonTestId"
                text="title"
    ...
    test('applies the primary button style consistently across themes', () => {
        const { getByTestId } = render(
            <Button
                testID="buttonTestId"
                text="Confirm"
        ...
        const textStyle = StyleSheet.flatten(getByTestId('buttonText').props.style);
        expect(textStyle).toMatchObject({
            color: themes.getDark().buttons.primary.colors.text,
        });
    });
});
...
describe('Button - Conditional content', () => {
    ...
    test('renders an activity indicator and hides text and icon when loading', () => {
...
describe('Button - User interactions', () => {
    ...
    test('invokes the onPress callback when pressed', () => {
    ...
    test('does not invoke the onPress callback when disabled', () => {
        const onPress = jest.fn();
        const { getByTestId } = render(
